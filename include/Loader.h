...
void Loader::Load(const char* dirname_, const char* including_string_, const char* label_) {
    Module::Module* temp_module = new Module::Load(dirname_, including_string_, label_, &DataStructureDefined, &variable_names, &VariableTypes, &eventweights, &variable_indices_list, TTree_name.c_str());
    Modules.push_back(temp_module);
}

void Loader::LoadWithCut(const char* dirname_, const char* including_string_, const char* label_, const char* cut_string_) {
    Module::Module* temp_module = new Module::LoadWithCut(dirname_, including_string_, label_, cut_string_ , &DataStructureDefined, &variable_names, &VariableTypes, &eventweights, &variable_indices_list, TTree_name.c_str());
    Modules.push_back(temp_module);
}

void Loader::Cut(const char* cut_string_) {
    Module::Module* temp_module = new Module::Cut(cut_string_, &variable_names, &VariableTypes, &eventweights, &variable_indices_list);
    Modules.push_back(temp_module);
}
...
std::shared_ptr<std::vector<double>> Loader::PrintInformation(const char* print_string_, const std::vector<std::string> Event_variable_list_) {
    ...
    Module::Module* temp_module = new Module::PrintInformation(print_string_, Event_variable_list_, temp_ptr, &variable_names, &VariableTypes, &eventweights, &variable_indices_list);
    Modules.push_back(temp_module);
    return temp_ptr;
}
...
void Loader::DrawTH1D(const char* expression_, const char* hist_title_, int nbins_, double x_low_, double x_high_, const char* png_name_) {
    Module::Module* temp_module = new Module::DrawTH1D(expression_, hist_title_, nbins_, x_low_, x_high_, png_name_, &variable_names, &VariableTypes, &eventweights, &variable_indices_list);
    Modules.push_back(temp_module);
}
...
void Loader::DrawTH1D(const char* expression_, const char* hist_title_, int nbins_, double x_low_, double x_high_, const char* png_name_, bool normalized_, bool LogScale_) {
    Module::Module* temp_module = new Module::DrawTH1D(expression_, hist_title_, nbins_, x_low_, x_high_, png_name_, normalized_, LogScale_, &variable_names, &VariableTypes, &eventweights, &variable_indices_list);
    Modules.push_back(temp_module);
}

void Loader::DrawTH1D(const char* expression_, const char* hist_title_, const char* png_name_) {
    Module::Module* temp_module = new Module::DrawTH1D(expression_, hist_title_, png_name_, &variable_names, &VariableTypes, &eventweights, &variable_indices_list);
    Modules.push_back(temp_module);
}

void Loader::DrawTH1D(const char* expression_, const char* hist_title_, const char* png_name_, bool normalized_, bool LogScale_) {
    Module::Module* temp_module = new Module::DrawTH1D(expression_, hist_title_, png_name_, normalized_, LogScale_, &variable_names, &VariableTypes, &eventweights, &variable_indices_list);
    Modules.push_back(temp_module);
}
...
void Loader::DrawTH2D(const char* x_expression_, const char* y_expression_, const char* hist_title_, int x_nbins_, double x_low_, double x_high_, int y_nbins_, double y_low_, double y_high_, const char* png_name_, const char* draw_option_) {
    Module::Module* temp_module = new Module::DrawTH2D(x_expression_, y_expression_, hist_title_, x_nbins_, x_low_, x_high_, y_nbins_, y_low_, y_high_, png_name_, draw_option_, &variable_names, &VariableTypes, &eventweights, &variable_indices_list);
    Modules.push_back(temp_module);
}
...
void Loader::DrawTH2D(const char* x_expression_, const char* y_expression_, const char* hist_title_, const char* png_name_, const char* draw_option_) {
    Module::Module* temp_module = new Module::DrawTH2D(x_expression_, y_expression_, hist_title_, png_name_, draw_option_, &variable_names, &VariableTypes, &eventweights, &variable_indices_list);
    Modules.push_back(temp_module);
}
...
void Loader::DrawStack(const char* expression_, const char* stack_title_, int nbins_, double x_low_, double x_high_, const char* png_name_) {
    Module::Module* temp_module = new Module::DrawStack(expression_, stack_title_, nbins_, x_low_, x_high_, png_name_, Signal_label_list, Background_label_list, Data_label_list, MC_label_list, &variable_names, &VariableTypes, &eventweights, &variable_indices_list);
    Modules.push_back(temp_module);
}
...
void Loader::DrawStack(const char* expression_, const char* stack_title_, int nbins_, double x_low_, double x_high_, const char* png_name_, bool normalized_, bool LogScale_) {
    Module::Module* temp_module = new Module::DrawStack(expression_, stack_title_, nbins_, x_low_, x_high_, png_name_, normalized_, LogScale_, Signal_label_list, Background_label_list, Data_label_list, MC_label_list, &variable_names, &VariableTypes, &eventweights, &variable_indices_list);
    Modules.push_back(temp_module);
}

void Loader::DrawStack(const char* expression_, const char* stack_title_, const char* png_name_) {
    Module::Module* temp_module = new Module::DrawStack(expression_, stack_title_, png_name_, Signal_label_list, Background_label_list, Data_label_list, MC_label_list, &variable_names, &VariableTypes, &eventweights, &variable_indices_list);
    Modules.push_back(temp_module);
}
...
void Loader::DrawStack(const char* expression_, const char* stack_title_, const char* png_name_, bool normalized_, bool LogScale_) {
    Module::Module* temp_module = new Module::DrawStack(expression_, stack_title_, png_name_, normalized_, LogScale_, Signal_label_list, Background_label_list, Data_label_list, MC_label_list, &variable_names, &VariableTypes, &eventweights, &variable_indices_list);
    Modules.push_back(temp_module);
}

void Loader::PrintSeparateRootFile(const char* path_, const char* prefix_, const char* suffix_) {
    Module::Module* temp_module = new Module::PrintSeparateRootFile(path_, prefix_, suffix_, &variable_names, &VariableTypes, &eventweights, &variable_indices_list, TTree_name.c_str());
    Modules.push_back(temp_module);
}

void Loader::PrintRootFile(const char* output_name_) {
    Module::Module* temp_module = new Module::PrintRootFile(output_name_, &variable_names, &VariableTypes, &eventweights, &variable_indices_list, TTree_name.c_str());
    Modules.push_back(temp_module);
}

void Loader::BCS(const char* expression_, const char* criteria_, const std::vector<std::string> Event_variable_list_) {
    Module::Module* temp_module = new Module::BCS(expression_, criteria_, Event_variable_list_, &variable_names, &VariableTypes, &eventweights, &variable_indices_list);
    Modules.push_back(temp_module);
}

void Loader::RandomBCS(const std::vector<std::string> Event_variable_list_) {
    Module::Module* temp_module = new Module::RandomBCS(Event_variable_list_, &variable_names, &VariableTypes, &eventweights, &variable_indices_list);
    Modules.push_back(temp_module);
}

void Loader::IsBCSValid(const std::vector<std::string> Event_variable_list_) {
    Module::Module* temp_module = new Module::IsBCSValid(Event_variable_list_, &variable_names, &VariableTypes, &eventweights, &variable_indices_list);
    Modules.push_back(temp_module);
}

void Loader::RandomEventSelection(int split_num_, int selected_index_, const std::vector<std::string> Event_variable_list_) {
    Module::Module* temp_module = new Module::RandomEventSelection(split_num_, selected_index_, Event_variable_list_, &variable_names, &VariableTypes, &eventweights, &variable_indices_list);
    Modules.push_back(temp_module);
}

std::shared_ptr<std::vector<double>> Loader::DrawFOM(const char* expression_, double MIN_, double MAX_, const char* png_name_) {
    std::shared_ptr<std::vector<double>> temp_ptr = std::make_shared<std::vector<double>>();
    Module::Module* temp_module = new Module::DrawFOM(expression_, MIN_, MAX_, png_name_, Signal_label_list, Background_label_list, temp_ptr, &variable_names, &VariableTypes, &eventweights, &variable_indices_list);
    Modules.push_back(temp_module);
    return temp_ptr;
}
...
std::shared_ptr<std::vector<double>> Loader::DrawFOM(const char* expression_, double MIN_, double MAX_, double NBin_, int rank_, const char* png_name_) {
    std::shared_ptr<std::vector<double>> temp_ptr = std::make_shared<std::vector<double>>();
    Module::Module* temp_module = new Module::DrawFOM(expression_, MIN_, MAX_, NBin_, rank_, png_name_, Signal_label_list, Background_label_list, temp_ptr, &variable_names, &VariableTypes, &eventweights, &variable_indices_list);
    Modules.push_back(temp_module);
    return temp_ptr;
}
...
std::shared_ptr<std::vector<double>> Loader::DrawPunziFOM(const char* equation_, double MIN_, double MAX_, double NSIG_initial_, double alpha_, const char* png_name_) {
    std::shared_ptr<std::vector<double>> temp_ptr = std::make_shared<std::vector<double>>();
    Module::Module* temp_module = new Module::DrawPunziFOM(equation_, MIN_, MAX_, NSIG_initial_, alpha_, png_name_, Signal_label_list, Background_label_list, temp_ptr, &variable_names, &VariableTypes, &eventweights, &variable_indices_list);
    Modules.push_back(temp_module);
    return temp_ptr;
}
...
std::shared_ptr<std::vector<double>> Loader::DrawPunziFOM(const char* equation_, double MIN_, double MAX_, double NBin_, double NSIG_initial_, double alpha_, int rank_, const char* png_name_) {
    std::shared_ptr<std::vector<double>> temp_ptr = std::make_shared<std::vector<double>>();
    Module::Module* temp_module = new Module::DrawPunziFOM(equation_, MIN_, MAX_, NBin_, NSIG_initial_, alpha_, rank_, png_name_, Signal_label_list, Background_label_list, temp_ptr, &variable_names, &VariableTypes, &eventweights, &variable_indices_list);
    Modules.push_back(temp_module);
    return temp_ptr;
}
...
std::shared_ptr<std::vector<double>> Loader::Draw2DPunziFOM(std::vector<std::tuple<const char*, double, double, int>> scan_conditions_, double NSIG_initial_, double alpha_, const char* png_name_) {
    std::shared_ptr<std::vector<double>> temp_ptr = std::make_shared<std::vector<double>>();
    Module::Module* temp_module = new Module::Draw2DPunziFOM(scan_conditions_, NSIG_initial_, alpha_, png_name_, Signal_label_list, Background_label_list, temp_ptr, &variable_names, &VariableTypes, &eventweights, &variable_indices_list);
    Modules.push_back(temp_module);
    return temp_ptr;
}
...
std::shared_ptr<std::vector<double>> Loader::Draw2DPunziFOM(std::vector<std::tuple<const char*, double, double, int>> scan_conditions_, const char* preselection_x_, const char* preselection_y_, double NSIG_initial_, double alpha_, const char* png_name_) {
    std::shared_ptr<std::vector<double>> temp_ptr = std::make_shared<std::vector<double>>();
    Module::Module* temp_module = new Module::Draw2DPunziFOM(scan_conditions_, preselection_x_, preselection_y_, NSIG_initial_, alpha_, png_name_, Signal_label_list, Background_label_list, temp_ptr, &variable_names, &VariableTypes, &eventweights, &variable_indices_list);
    Modules.push_back(temp_module);
    return temp_ptr;
}
...
std::shared_ptr<double> Loader::CalculateAUC(const char* equation_, double MIN_, double MAX_, const char* output_name_, const char* write_option_) {
    ...
    Module::Module* temp_module = new Module::CalculateAUC(equation_, MIN_, MAX_, output_name_, write_option_, Signal_label_list, Background_label_list, temp_ptr, &variable_names, &VariableTypes, &eventweights, &variable_indices_list);
    Modules.push_back(temp_module);
    return temp_ptr;
}
...
void Loader::FastBDTTrain(std::vector<std::string> input_variables_, const char* Signal_preselection_, const char* Background_preselection_, std::map<std::string, double> hyperparameters_, const char* path_, const char* output_name_) {
    Module::Module* temp_module = new Module::FastBDTTrain(input_variables_, Signal_preselection_, Background_preselection_, hyperparameters_, path_, output_name_, Signal_label_list, Background_label_list, &variable_names, &VariableTypes, &eventweights, &variable_indices_list);
    Modules.push_back(temp_module);
}
...
void Loader::FastBDTTrain(std::vector<std::string> input_variables_, const char* Signal_preselection_, const char* Background_preselection_, std::map<std::string, double> hyperparameters_, bool balanced_weight_, const char* path_, const char* output_name_) {
    Module::Module* temp_module = new Module::FastBDTTrain(input_variables_, Signal_preselection_, Background_preselection_, hyperparameters_, balanced_weight_, path_, output_name_, Signal_label_list, Background_label_list, &variable_names, &VariableTypes, &eventweights, &variable_indices_list);
    Modules.push_back(temp_module);
}
...
void Loader::FastBDTApplication(std::vector<std::string> input_variables_, const char* classifier_path_, const char* branch_name_) {
    Module::Module* temp_module = new Module::FastBDTApplication(input_variables_, classifier_path_, branch_name_, &variable_names, &VariableTypes, &eventweights, &variable_indices_list);
    Modules.push_back(temp_module);
}

void Loader::DefineNewVariable(const char* equation_, const char* new_variable_name_) {
    Module::Module* temp_module = new Module::DefineNewVariable(equation_, new_variable_name_, &variable_names, &VariableTypes, &eventweights, &variable_indices_list);
    Modules.push_back(temp_module);
}

void Loader::RemoveVariable(std::vector<std::string> removed_variable_names_) {
    Module::Module* temp_module = new Module::RemoveVariable(removed_variable_names_, &variable_names, &VariableTypes, &eventweights, &variable_indices_list);
    Modules.push_back(temp_module);
}
...
void Loader::ConditionalPairDefineNewVariable(std::map<std::string, std::string> condition_equation__criteria_equation_list_, int condition_order_, const char* new_variable_name_) {
    Module::Module* temp_module = new Module::ConditionalPairDefineNewVariable(condition_equation__criteria_equation_list_, condition_order_, new_variable_name_, &variable_names, &VariableTypes, &eventweights, &variable_indices_list);
    Modules.push_back(temp_module);
}

void Loader::GetAverage(std::vector<std::string> equations_, const char* new_variable_name_) {
    Module::Module* temp_module = new Module::GetAverage(equations_, new_variable_name_, &variable_names, &VariableTypes, &eventweights, &variable_indices_list);
    Modules.push_back(temp_module);
}

void Loader::GetStdDev(std::vector<std::string> equations_, const char* new_variable_name_) {
    Module::Module* temp_module = new Module::GetStdDev(equations_, new_variable_name_, &variable_names, &VariableTypes, &eventweights, &variable_indices_list);
    Modules.push_back(temp_module);
}

void Loader::GetDiff(std::vector<std::string> equations_, int order_, const char* new_variable_name_) {
    Module::Module* temp_module = new Module::GetDiff(equations_, order_, new_variable_name_, &variable_names, &VariableTypes, &eventweights, &variable_indices_list);
    Modules.push_back(temp_module);
}
...
void Loader::FillDataSet(RooDataSet* dataset_, std::vector<RooRealVar*> realvars_, std::vector<std::string> equations_) {
    Module::Module* temp_module = new Module::FillDataSet(dataset_, realvars_, equations_, &variable_names, &VariableTypes, &eventweights, &variable_indices_list);
    Modules.push_back(temp_module);
}

void Loader::FillTProfile(TProfile* tprofile_, std::string equation_x_, std::string equation_y_) {
    Module::Module* temp_module = new Module::FillTProfile(tprofile_, equation_x_, equation_y_, &variable_names, &VariableTypes, &eventweights, &variable_indices_list);
    Modules.push_back(temp_module);
}

void Loader::FillTH1D(TH1D* th1d_, std::string equation_) {
    Module::Module* temp_module = new Module::FillTH1D(th1d_, equation_, &variable_names, &VariableTypes, &eventweights, &variable_indices_list);
    Modules.push_back(temp_module);
}

void Loader::FillCustomizedTH1D(TH1D* th1d_, std::vector<std::string> equations_, double (*custom_function_)(std::vector<double>)) {
    Module::Module* temp_module = new Module::FillCustomizedTH1D(th1d_, equations_, custom_function_, &variable_names, &VariableTypes, &eventweights, &variable_indices_list);
    Modules.push_back(temp_module);
}

void Loader::FillTH2D(TH2D* th2d_, const char* x_expression_, const char* y_expression_) {
    Module::Module* temp_module = new Module::FillTH2D(th2d_, x_expression_, y_expression_, &variable_names, &VariableTypes, &eventweights, &variable_indices_list);
    Modules.push_back(temp_module);
}
...
void Loader::FillCustomizedTH2D(TH2D* th2d_, std::vector<std::string> equations_, double (*x_custom_function_)(std::vector<double>), double (*y_custom_function_)(std::vector<double>)) {
    Module::Module* temp_module = new Module::FillCustomizedTH2D(th2d_, equations_, x_custom_function_, y_custom_function_, &variable_names, &VariableTypes, &eventweights, &variable_indices_list);
    Modules.push_back(temp_module);
}

void Loader::PrintEvent(std::vector<std::string> print_variables_) {
    Module::Module* temp_module = new Module::PrintEvent(print_variables_, &variable_names, &VariableTypes, &eventweights, &variable_indices_list);
    Modules.push_back(temp_module);
}
...
std::shared_ptr<std::vector<double>> Loader::ABCDmethod(const char* region_A_, const char* region_B_, const char* region_C_, const char* region_D_, bool WeightSumError_) {
    std::shared_ptr<std::vector<double>> temp_ptr = std::make_shared<std::vector<double>>();
    Module::Module* temp_module = new Module::ABCDmethod(region_A_, region_B_, region_C_, region_D_, WeightSumError_, temp_ptr, &variable_names, &VariableTypes, &eventweights, &variable_indices_list);
    Modules.push_back(temp_module);
    return temp_ptr;
}
...
std::shared_ptr<std::vector<double>> Loader::ABCDmethod(const char* region_A_, const char* region_B_, const char* region_C_, const char* region_D_, const char* region_Aprime_, const char* region_Bprime_, const char* region_Cprime_, const char* region_Dprime_, bool WeightSumError_) {
    std::shared_ptr<std::vector<double>> temp_ptr = std::make_shared<std::vector<double>>();
    Module::Module* temp_module = new Module::ABCDmethod(region_A_, region_B_, region_C_, region_D_, region_Aprime_, region_Bprime_, region_Cprime_, region_Dprime_, WeightSumError_, temp_ptr, &variable_names, &VariableTypes, &eventweights, &variable_indices_list);
    Modules.push_back(temp_module);
    return temp_ptr;
}
...
void Loader::DefineAddModel(const std::string& model_id_, const std::vector<std::string>& pdf_ids_, const std::vector<std::string>& coefficient_ids_, bool recursive_fractions_) {
    Module::Module* temp_module = new Module::DefineAddModel(model_id_, pdf_ids_, coefficient_ids_, recursive_fractions_, &variable_names, &VariableTypes, &eventweights, &variable_indices_list, &fitmanager);
    Modules.push_back(temp_module);
}

void Loader::DefineProductModel(const std::string& model_id_, const std::vector<std::string>& pdf_ids_, double cutoff_) {
    Module::Module* temp_module = new Module::DefineProductModel(model_id_, pdf_ids_, cutoff_, &variable_names, &VariableTypes, &eventweights, &variable_indices_list, &fitmanager);
    Modules.push_back(temp_module);
}
...
void Loader::DefineGenericModel(const std::string& model_id_, const std::string& expression_, const std::vector<std::string>& argument_ids_) {
    Module::Module* temp_module = new Module::DefineGenericModel(model_id_, expression_, argument_ids_, &variable_names, &VariableTypes, &eventweights, &variable_indices_list, &fitmanager);
    Modules.push_back(temp_module);
}
...
void Loader::DefineSimultaneousModel(const std::string& model_id_, const std::string& category_id_, const std::vector<std::pair<std::string, std::string>>& state_pdf_ids_) {
    Module::Module* temp_module = new Module::DefineSimultaneousModel(model_id_, category_id_, state_pdf_ids_, &variable_names, &VariableTypes, &eventweights, &variable_indices_list, &fitmanager);
    Modules.push_back(temp_module);
}
...
void Loader::DefineTF1(const std::string& function_id_, const std::string& formula_, double xmin_, double xmax_, const std::vector<TF1ParameterDefinition>& parameters_) {
    Module::Module* temp_module = new Module::DefineTF1(function_id_, formula_, xmin_, xmax_, parameters_, &variable_names, &VariableTypes, &eventweights, &variable_indices_list, &fitmanager);
    Modules.push_back(temp_module);
}
...
void Loader::Fit(const std::string& fit_id_, const std::string dataset_id_, const std::string& model_id_, const FitOptions& options_) {
    Module::Module* temp_module = new Module::Fit(fit_id_, dataset_id_, model_id_, options_, &variable_names, &VariableTypes, &eventweights, &variable_indices_list, &fitmanager);
    Modules.push_back(temp_module);
}
...
void Loader::ExportFitResult(const std::string& filename_, const std::vector<std::string>& fit_ids_) {
    Module::Module* temp_module = new Module::ExportFitResult(filename_, fit_ids_, &variable_names, &VariableTypes, &eventweights, &variable_indices_list, &fitmanager);
    Modules.push_back(temp_module);
}
...
void Loader::CreateNLL(const std::string& nll_id_, const std::string& dataset_id_, const std::string& model_id_, const FitOptions& options_) {
    Module::Module* temp_module = new Module::CreateNLL(nll_id_, dataset_id_, model_id_, options_, &variable_names, &VariableTypes, &eventweights, &variable_indices_list, &fitmanager);
    Modules.push_back(temp_module);
}

void Loader::PlotNLL(const std::string& nll_id_, const std::string& parameter_id_, const std::string& plot_name_) {
    Module::Module* temp_module = new Module::PlotNLL(nll_id_, parameter_id_, plot_name_, &variable_names, &VariableTypes, &eventweights, &variable_indices_list, &fitmanager);
    Modules.push_back(temp_module);
}

void Loader::PlotProfileNLL(const std::string& nll_id_, const std::string& poi_id_, const std::string& plot_name_) {
    Module::Module* temp_module = new Module::PlotProfileNLL(nll_id_, poi_id_, plot_name_, &variable_names, &VariableTypes, &eventweights, &variable_indices_list, &fitmanager);
    Modules.push_back(temp_module);
}

void Loader::SaveWorkspace(const std::string& filename_) {
    Module::Module* temp_module = new Module::SaveWorkspace(filename_, &variable_names, &VariableTypes, &eventweights, &variable_indices_list, &fitmanager);
    Modules.push_back(temp_module);
}

void Loader::LoadWorkspace(const std::string& filename_, const std::string& workspace_name_) {
    Module::Module* temp_module = new Module::LoadWorkspace(filename_, workspace_name_, &variable_names, &VariableTypes, &eventweights, &variable_indices_list, &fitmanager);
    Modules.push_back(temp_module);
}
